...
class TestIcebergColumn(unittest.TestCase):
    def test_convert_table_stats_with_no_statistics(self):
        self.assertDictEqual(IcebergColumn.convert_table_stats(None), {})

    def test_convert_table_stats_with_bytes(self):
        self.assertDictEqual(
            IcebergColumn.convert_table_stats("123456789 bytes"),
            {
    ...
    def test_convert_table_stats_with_bytes_and_rows(self):
        self.assertDictEqual(
            IcebergColumn.convert_table_stats("1234567890 bytes, 12345678 rows"),
            {
                "stats:bytes:description": "",
                "stats:bytes:include": True,
                "stats:bytes:label": "bytes",
